    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-slate-900 transition-colors duration-300 px-4">
      <div className="text-center">
        <div className="flex justify-center">
          <PageKicker icon={SearchX} label="Not found" className="justify-center" />
        </div>
        <h1 className="mt-4 text-9xl font-bold text-gray-900 dark:text-white mb-4 transition-colors duration-300">404</h1>
