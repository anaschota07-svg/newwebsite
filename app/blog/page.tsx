      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-slate-900 dark:text-slate-400 max-w-2xl mx-auto">
            Browse {publishedPosts.length} published articles across finance, study, technology, and practical digital topics
          </p>
          <p className="text-sm text-slate-600 dark:text-slate-500 max-w-3xl mx-auto mt-4 leading-relaxed">
            ...
            and updated when recommendations, examples, or guidance become outdated.
          </p>
        </motion.div>
              ...
              {[
                {
                  ...
                  body: 'Our guides are designed to solve specific user problems, not just target keywords. We focus on practical steps, examples, and context that help readers make sense of a topic.',
                },
                {
        ...
        <section className="glass rounded-3xl p-8 border border-white/10 mb-12">
            ...
            <p className="text-slate-700 dark:text-slate-400 leading-relaxed mb-4">
              The blog section exists to answer real user questions, not pad out the site with filler content. That means
              we prioritize walkthroughs, comparisons, and explainers that help readers understand a topic clearly and use the advice in practice.
            </p>
            <p className="text-slate-700 dark:text-slate-400 leading-relaxed">
              The goal is a blog library that stays useful, readable, and easier to trust, with clear
